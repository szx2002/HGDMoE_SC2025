...
USE_LRU_POLICY=False     # 是否使用新policy？ false表示使用新policy
...
def main(model_name, req_file, max_embed_tokens, output_path):    
    ...
    # 遍历 NumSteps
    for numSteps in range(3, min(9, model.config.num_hidden_layers)):
...
if __name__ == "__main__":
    ...
    ResFilePath = "./Mot_Test_Res/NumSteps-WaitLatency"
    if not USE_LRU_POLICY and USE_CACHE_AWARE and USE_NEW_MODEL:
        ResFilePath = "./Mot_Test_Res/NumSteps-WaitLatency-Overall"
    elif USE_NEW_MODEL:
        ResFilePath = "./Mot_Test_Res/NumSteps-WaitLatency-NewModel"
    elif not USE_LRU_POLICY:
        ResFilePath = "./Mot_Test_Res/NumSteps-WaitLatency-NewPolicy"
    elif USE_CACHE_AWARE:
        ResFilePath = "./Mot_Test_Res/NumSteps-WaitLatency-CacheAware"
