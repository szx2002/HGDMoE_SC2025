...
class BaseModelOutputWithPast(ModelOutput):
    ...
    moe_latency: Optional[float] = None
    cache_mis_rate: Optional[Tuple[float]] = None
    wait_latency: Optional[float] = None
    cache_mis_latency: Optional[float] = None
    all_layer_accuracy: Optional[Tuple[float, ...]] = None
    avg_accuracy: Optional[float] = None
    predicted_experts: Optional[Tuple[Tuple[int]]] = None
    actual_experts: Optional[Tuple[Tuple[int]]] = None
